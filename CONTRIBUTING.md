...
Thank you for your interest in contributing to NovaBilling! We welcome community contributions, bug reports, feature requests, and documentation improvements.
...
3.  **Create a Branch**: Create a descriptive branch name (e.g. `feat/tier-upgrades` or `fix/charge-timestamps`).
